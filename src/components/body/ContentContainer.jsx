...
const ContentContainer = ({ content }) => {
  const contentToView = (
    <div className="flex flex-col items-center">
      <div className="aspect-square w-16 rounded-xl border border-stone-700 bg-stone-600 p-2 shadow-sm shadow-stone-950 hover:bg-stone-700">
        {content.type === "page" ? (
      ...
      <p className="mt-1 font-sans text-sm font-normal">{content.title}</p>
    </div>
  );
